...
echo "halo, " . $name . "! Selamat datang di garuda cyber!";
echo "<br>";
}
greetings("nana");
greetings("Wahyu");
...
Soal No 2 
Reverse String 
Buatlah sebuah function reverseString() untuk mengubah string berikut menjadi kebalikannya menggunakan function dan looping (for/while/do while). Function 
reverseString menerima satu parameter berupa string. 
